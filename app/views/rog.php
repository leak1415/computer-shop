        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex flex-wrap gap-2 justify-content-center">
                    <a href="?page=rog&filter=all" class="btn btn-outline-primary active">All ROG</a>
                    <a href="?page=rog&filter=rtx4090" class="btn btn-outline-primary">RTX 4090</a>
                    <a href="?page=rog&filter=rtx4080" class="btn btn-outline-primary">RTX 4080</a>
                    <a href="?page=rog&filter=rtx4070" class="btn btn-outline-primary">RTX 4070</a>
                    <a href="?page=rog&filter=i9" class="btn btn-outline-primary">Intel i9</a>
                    <a href="?page=rog&filter=ryzen9" class="btn btn-outline-primary">AMD Ryzen 9</a>
                </div>
            </div>
        </div>
